    ...
    <>
      ...
      <div className="min-h-screen bg-[#111] text-white relative overflow-hidden">
        ...
        <Link href="/mobile" legacyBehavior>
          ...
          >
            <div className="text-lg font-bold font-fallback" style={{ fontFamily: 'CS-Valcon-Drawn-akhr7k, "Arial Black", "Helvetica Black", sans-serif' }}>
              emotional studios
            </div>
          </a>
        </Link>
        ...
        {/* 메인 컨텐츠 */}
        <div className="flex flex-col items-center justify-center min-h-screen px-4 pt-20 pb-24">
          <motion.div
          ...
          >
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-white/80">Make the most of your 20-minute session</p>
            </div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <button
                      onClick={() => router.push('/mobile-support')}
            ...
            >
              <button
                ...
                className="bg-transparent border border-white text-white rounded-full py-3 px-4 text-sm font-bold transition-all duration-200 hover:bg-white hover:text-black"
                style={{ fontFamily: 'CS-Valcon-Drawn-akhr7k, "Arial Black", "Helvetica Black", sans-serif' }}
              >
                Pose Guide
              </button>
