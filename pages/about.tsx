                  ...
                  <div className="absolute inset-0 bg-black/90 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col items-center justify-center p-10 h-full w-full">
                    <div className="w-full flex flex-col items-center">
                      ...
                      <div className="flex justify-center items-center gap-8 mt-8">
                        {/* Instagram SVG */}
                        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="mx-2 svg-glitch-wrapper text-white w-16 h-16">
                        ...
                        {/* Facebook SVG */}
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="mx-2 svg-glitch-wrapper text-white w-16 h-16">
                          <div className="base-icon">
                        ...
                        {/* YouTube SVG */}
                        <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="mx-2 svg-glitch-wrapper text-white w-16 h-16">
                          <div className="base-icon">
