          ...
          <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
            <div className="text-center text-white">
              <motion.h1
                ...
                className="text-5xl md:text-7xl font-rock-salt mb-4 animate-tracking-in text-[#ff6100]"
              >
        ...
        <section className="relative py-20 bg-[#fff0c6] overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-rock-salt text-[#ff6100] mb-6 animate-tracking-in">
                Emotional Moment
              </h2>
