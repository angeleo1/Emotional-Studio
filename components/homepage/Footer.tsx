      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 sm:gap-8">
          ...
          <div className="flex justify-center items-center gap-8">
            ...
            {/* Facebook SVG */}
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="mx-2 text-white w-12 h-12">
            ...
            {/* YouTube SVG */}
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="mx-2 text-white w-12 h-12">
