    ...
    <div className="relative w-full h-screen overflow-hidden bg-background">
      ...
      >
        {/* <div className="text-center">
                    <h1 className="text-6xl font-bold text-white/10 mb-4">emotional studios</h1>
          <p className="text-lg text-white/30">Move your mouse and click to interact</p>
        </div> */}
      </motion.div>
    </div>
  );
