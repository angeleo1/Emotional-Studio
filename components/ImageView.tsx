    ...
    <div className={`mb-8 border-b pb-8 flex flex-col md:flex-row gap-8 items-start transition-all duration-1000 ${isDark ? 'border-zinc-800' : 'border-zinc-200'}`}>
      ...
      <div className="flex-1 pt-2">
        ...
        <div className="grid grid-cols-1 gap-6">
          {cat.items.map((item) => (
            <div key={item.name} className={`p-6 border transition-all duration-500 ${isDark ? 'border-zinc-800 bg-[#111111] hover:bg-zinc-900' : 'border-zinc-200 bg-white hover:border-black'}`}>
