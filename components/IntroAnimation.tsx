        ...
        <div style={{ marginTop: '8rem' }}>
          ...
          >
            <div style={{ display: 'flex', gap: '1.5rem', margin: '0.7rem 0', alignItems: 'center' }}>
              ...
              <svg width="36" height="36" viewBox="0 0 36 36"><polygon points="8,6 28,18 8,30" fill="#FF6100" /></svg>
              <svg width="36" height="36" viewBox="0 0 36 36"><polygon points="8,6 28,18 8,30" fill="#FF6100" /></svg>
              {/* SNS 아이콘 영역 - 어바웃어스 스타일 */}
              <div style={{ display: 'flex', gap: '1.2rem', marginLeft: '1.2rem' }}>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="mx-2 svg-glitch-wrapper w-12 h-12" style={{ color: '#FF6100' }}>
                ...
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="mx-2 svg-glitch-wrapper w-12 h-12" style={{ color: '#FF6100' }}>
                  <div className="base-icon" style={{ color: '#FF6100', fill: '#FF6100' }}>
