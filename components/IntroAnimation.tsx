    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="svg-glitch-wrapper w-8 h-8 md:w-12 md:h-12" style={{ color: '#FF6100' }}>
            <div className="base-icon" style={{ color: '#FF6100', fill: '#FF6100' }}>
          ...
          <a href="https://www.youtube.com/channel/UCiD4_8JWUt24lkJwYMum8NA" target="_blank" rel="noopener noreferrer" className="svg-glitch-wrapper w-8 h-8 md:w-12 md:h-12" style={{ color: '#FF6100' }}>
            <div className="base-icon" style={{ color: '#FF6100', fill: '#FF6100' }}>
